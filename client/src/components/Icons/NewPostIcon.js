...
<path className="st0" d="M19.8,0c-5.5,0-10,4.5-10,10c0,3.8,2.1,7.2,5.4,8.9c0,0,0,0.1,0,0.1v4.5c0,1.1,0.7,2.8,2.8,2.8h3.6
	...
	h-5c-0.6,0-1,0.4-1,1s0.4,1,1,1h5c0.6,0,1-0.4,1-1S22.9,29.7,22.3,29.7z" fill="#fff"/>
</svg>
);
